...
if __name__ == '__main__':
    ...
    # Added by Ruihan
    parser.add_argument('--mesh_resolution', type=int, default=256, help="resolution for marching cube for saving mesh")

    opt = parser.parse_args()

    print(f"Finish parsing arguments")
    ...
    print("Option --ff or --tcnn selected")
